...
# checked: 8.0 ok
Selecione o aplicativo   [Arguments]    ${menu}
    Click Link				xpath=//nav/ul//li/div/a[descendant::span/text()[normalize-space()='${menu}']]
    Wait Until Page Contains Element	xpath=//ul[contains(@class, 'o_menu_sections')]
    ElementPostCheck

# checked: 8.0 ok
Selecione o menu superior    [Arguments]    ${menu}
...
Selecione a mesa
    [Arguments]    ${name}
    Click Element				xpath=//div[@class='table']//span[@class='label'][descendant::text()[normalize-space()='${name}']]
